	    ...
	    return (
	      React.createElement("html", null, 
	        React.createElement("head", null, 
	          ...
	          React.createElement("title", null, this.props.name), 
	          React.createElement("style", null, this.props.bass)
	        ), 
	        React.createElement("body", {className: 'px3 ' + (this.state.nightmode ? 'white bg-black' : '')}, 
	          React.createElement(Demo, React.__spread({},  this.props, {toggleNightmode: this.toggleNightmode})), 
	          React.createElement("div", {className: "container py3"}, 
	            React.createElement(Markdown, null, 
	              this.props.readme
	            )
	          ), 
	          React.createElement("footer", {className: "container py2 border-top"}, 
	            React.createElement("div", {className: "flex flex-wrap mxn2"}, 
	              React.createElement("a", {href: this.props.homepage, 
	                className: "button button-transparent"}, 
	                "GitHub"
	              ), 
	              React.createElement("a", {href: 'http://npmjs.com/package/'+this.props.name, 
	                className: "button button-transparent"}, 
	                "npm"
	              ), 
	              React.createElement("div", {className: "flex-auto"}), 
	              React.createElement("a", {href: "http://jxnblk.com", 
	                className: "button button-transparent"}, 
	                "Made by Jxnblk"
	              )
	            )
	          ), 
	          React.createElement("script", {id: "initial-props", 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = React.createClass({displayName: "Demo",
	  ...
	  renderIcon: function(name, i) {
	    return (
	      React.createElement("div", {key: 'icon-'+i, 
	        style: {width:'6rem'}, 
	        className: "center p2"}, 
	        React.createElement(Icon, {name: name, className: "inline-block"}), 
	        React.createElement("div", {className: "h6"}, name)
	      )
	    )
	  },
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", null, 
	        React.createElement("div", {className: "flex flex-end mt1 mb2"}, 
	          React.createElement("div", {className: "flex-auto"}), 
	          React.createElement("div", {className: "px1"}, 
	            React.createElement("label", {htmlFor: "size-select", 
	              className: "h5 bold block"}, 
	              "Size"
	            ), 
	            React.createElement("select", {id: "size-select", 
	              className: "field-light", 
	              value: this.state.size, 
	              onChange: this.handleSizeChange}, 
	              this.props.sizes.map(function(size, i) {
	                return React.createElement("option", {key: 'size-'+i, value: size, label: size})
	              })
	            )
	          ), 
	          React.createElement("div", {className: "px1"}, 
	            React.createElement("label", {htmlFor: "color-select", 
	              className: "h5 bold block"}, 
	              "Color"
	            ), 
	            React.createElement("select", {id: "color-select", 
	              className: "field-light", 
	              value: this.state.color, 
	              onChange: this.handleColorChange}, 
	              this.props.colors.map(function(color, i) {
	                return React.createElement("option", {key: 'color-'+i, value: color, label: color})
	              })
	            )
	          ), 
	          React.createElement("button", {onClick: this.props.toggleNightmode, 
	            ...
	            React.createElement("svg", {viewBox: "0 0 24 24", 
	              ...
	              React.createElement("path", {d: "M12 0, A 12 12 0 0 0 12 24, A 12 12 0 0 0 12 0 M12 2 V22 A10 10 0 0 1 12 2"})
	            ), 
	            React.createElement("span", {className: "hide"}, "Background color")
	          )
	        ), 
	        React.createElement("div", {className: 'flex flex-wrap flex-justify mxn2 ' + this.state.color, 
	          style: styles.icons}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var paths = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientReactRootIndex = __webpack_require__(54);
	var DefaultEventPluginOrder = __webpack_require__(55);
	var EnterLeaveEventPlugin = __webpack_require__(56);
	var ExecutionEnvironment = __webpack_require__(27);
	var HTMLDOMPropertyConfig = __webpack_require__(57);
	var MobileSafariClickEventPlugin = __webpack_require__(58);
	var ReactBrowserComponentMixin = __webpack_require__(59);
	var ReactClass = __webpack_require__(10);
	var ReactComponentBrowserEnvironment =
	  __webpack_require__(49);
	var ReactDefaultBatchingStrategy = __webpack_require__(60);
	var ReactDOMComponent = __webpack_require__(50);
	var ReactDOMButton = __webpack_require__(61);
	var ReactDOMForm = __webpack_require__(62);
	var ReactDOMImg = __webpack_require__(63);
	var ReactDOMIDOperations = __webpack_require__(64);
	var ReactDOMIframe = __webpack_require__(65);
	var ReactDOMInput = __webpack_require__(66);
	var ReactDOMOption = __webpack_require__(67);
	var ReactDOMSelect = __webpack_require__(68);
	var ReactDOMTextarea = __webpack_require__(69);
	var ReactDOMTextComponent = __webpack_require__(16);
	var ReactElement = __webpack_require__(13);
	var ReactEventListener = __webpack_require__(70);
	var ReactInjection = __webpack_require__(71);
	var ReactInstanceHandles = __webpack_require__(18);
	var ReactMount = __webpack_require__(19);
	var ReactReconcileTransaction = __webpack_require__(72);
	var SelectEventPlugin = __webpack_require__(73);
	var ServerReactRootIndex = __webpack_require__(74);
	var SimpleEventPlugin = __webpack_require__(75);
	var SVGDOMPropertyConfig = __webpack_require__(76);

	var createFullPageComponent = __webpack_require__(77);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(18);
	var ReactInstanceMap = __webpack_require__(38);
	var ReactMarkupChecksum = __webpack_require__(83);
	var ReactPerf = __webpack_require__(20);
	var ReactReconciler = __webpack_require__(22);
	var ReactUpdateQueue = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(30);
	var LocalEventTrapMixin = __webpack_require__(109);
	var ReactBrowserComponentMixin = __webpack_require__(59);
	var ReactClass = __webpack_require__(10);
	var ReactElement = __webpack_require__(13);
